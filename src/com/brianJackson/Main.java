...
public class Main {
    ...
    public static void main(String[] args) {
	    DeluxeHamburger ddHamburger = new DeluxeHamburger("white","beef", true, true);
	    ddHamburger.totals();
	    Hamburger baseBurger = new Hamburger("Wheat", "Cow");
        baseBurger.getBaconCost();
        baseBurger.getTomatoCost();
        baseBurger.total();
        HealthyBurger veganBurger = new HealthyBurger("rye", "bean");
        veganBurger.getAddAvocado();
        veganBurger.getAddQuinoa();
        veganBurger.getBaconCost();
        veganBurger.total();
    }
